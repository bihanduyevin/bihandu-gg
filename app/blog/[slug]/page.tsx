      ...
      <div className="relative z-10">
        <article className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          <Reveal
            ...
            threshold={0.1}
          >
            <div className="mb-16 aspect-[16/9] w-full overflow-hidden border border-[var(--border)] bg-[var(--surface)]/80 backdrop-blur-[2px] md:mb-24 md:aspect-[21/9]">
              {post.imageUrl ? (
                <img
                  src={post.imageUrl}
                  alt={post.title}
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12">
              {relatedPosts.map((relatedPost, index) => (
                ...
                >
                  ...
                  >
                    <div className="mb-6 aspect-[16/9] overflow-hidden border border-[var(--border)] bg-[var(--surface)]/70 transition-colors duration-500 group-hover:border-[var(--accent-primary)]/50">
