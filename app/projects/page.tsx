            ...
            >
              ...
              >
                <Reveal
                  ...
                  threshold={0.2}
                >
                  <div className="relative aspect-[4/3] overflow-hidden rounded-sm border border-[var(--border)] bg-[var(--surface)] transition-colors duration-500 hover:border-[var(--accent-primary)]/50 lg:aspect-[16/10]">
                    <div
                  ...
                  {project.technologies.map(
                    (tech, techIndex) => (
                      <Reveal
                        ...
                        animation="fade-up"
                      >
                        <span className="inline-flex rounded-full border border-[var(--border)] bg-[var(--surface)] px-3 py-1 text-xs tracking-wider text-[var(--muted)]">
                          {tech}
                        </span>
                      </Reveal>
                    ),
